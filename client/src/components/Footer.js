			...
			<div className="actualFooter">
			  ...
			  <div className="navCopy">
			  	...
			  	<div className="footerLinks" as="h3"><a target="_blank" rel="noopener noreferrer" className="footerALinks" href="/creativearts">Creative Arts</a></div>
			  		<span>|</span>
			  	<div className="footerLinks" as="h3"><a target="_blank" rel="noopener noreferrer" className="footerALinks" href="/community">Community Service</a></div>
			  		<span>|</span>
...
f
				<div className="feedback">
					<a className="bottomMailTo" href="mailto:contact@fit2recover.org" target="_top">
