        ...
        <div className="actualFooter">
          <div className="whoWeAre">
            <h6 className="whoWords">
              Established in 2013, Fit To Recover is built on the promise to
              make a difference in the recovery and physical fitness communities
              by bringing them together into one group with shared goals. At Fit
              To Recover, we support one another in physical activity, community
              gatherings, nutritional insights, and creative endeavors.
            </h6>
          </div>
          ...
          <div className="feedback">
            ...
            >
              ...
              &nbsp;We'd love to hear from You - Feedback, Comments,
              Testimonials&nbsp;
              <Icon name="mail" color="white" />
            </a>
          </div>
