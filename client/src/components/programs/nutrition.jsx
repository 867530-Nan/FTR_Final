...
Have you ever seen broccoli grow? Ever wondered how many different
              ...
              your own food! */}
                ...
                {/* <Card color='teal' raised centered className='classCard'>
                  ...
                  >
                    <Card.Description>
                      Preparing food as a group establishes and strengthens connections
                      with others. Come to the FTR Kitchen with a few ingredients and
                      leave with tupperware full of healthy meals for your week. Little to
                      no experience in the kitchen? No problem! We're all here for each
                      other. View the schedule and sign up here. You will be assigned
                ...
                {/* <Card color='green' raised centered className='classCard'>
                  ...
                  >
                    <Card.Description>
                      Meet one-on-one with a registered dietitian to meet your personal
                      nutrition goals. With a no-diet and individualized approach, we will
                      work together to help you tune into your hunger cues and nutritional
                      needs that will be the foundation for nourishing yourself. We'll
                      focus on realistic goals and sustainable strategies that will
                ...
                <Card color='red' raised centered className='classCard'>
                  ...
                  >
                    <Card.Description>
                      Food to Recover provides group nutrition education, cooking classes,
                      one-on-one counseling for clients, and facility menu reviews. All
                      services are performed by a registered dietitian. Contact Georgia
                      Gregersen for more information!
                    </Card.Description>
                    <Card.Description>
                      Sample classes include: Mindful Eating, Important Nutrients in
