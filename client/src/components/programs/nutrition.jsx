...
class Nutrition extends Component {
	...
	displayPosts = () => {
		return this.state.posts.items.map( post =>
	      ...
	      <Item.Content className="blogContent" as='a' target="_blank" rel="noreferrer noopener" href={post.url}>
			...
			return (
				<div>
					...
					<div className="nourishingRecovery">
						<div 
							className="programWordsh2"
						>
							Food To Recover promotes connecting with food, with others, and with ourselves.
						</div>
						<div 
							className="programWordsh3"
						>
							Together, we learn about the importance of proper nutrition in our daily lives, how to eat mindfully, and how to create our own healthy meals.
						</div>
					</div>
					...
					<div className="nutritionBottom">
						<p className="nutritionBottomWords">Proper nutrition is the foundation of good health. It can be especially important during recovery to help keep blood sugars stable and reduce cravings, to improve and stabilize mood, and to replenish nutritional deficiencies that may have occurred during substance use.</p>
					</div>
