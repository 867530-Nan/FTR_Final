      ...
      if (index % 2 === 0) {
        return (
          <Grid
            columns={2}
            stackable
            className="programs programsBlack"
  ...
  render() {
    return (
      <div>
        ...
        <div className="introFitness" style={styles.introFitness}>
          <div>
            ...
            <p className="introEnergy" style={styles.introEnergy}>
              All inclusive community of discipline, humility, patience, and
              trust
            </p>
          </div>
        </div>
        ...
        <div>
          <a name="fitness-jump" alt="this marks the start of fitness programs">
            {" "}
          </a>
        </div>
