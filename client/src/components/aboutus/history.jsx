...
class History extends Component {
	...
	render() {
		return (
	<div>
			<div style={styles.topPadding}></div>
			...
			<div className="redstripe" style={styles.redstripe}>
				<div style={styles.redStripeWords}>
					<h2 className="redStripeWords">	Fit To Recover started as a small group of friends who wanted to support each other in sobriety through exercise and fellowship. They’d meet each Saturday to run the hills of Sugarhouse Park and share their dreams and fears of life in recovery.<br/>
																					The group grew in size. Together they got stronger.<br/>
																					Soon, an entire community formed around the group's passions in what we call our 4 Pillars: exercise, nutrition, creative expression and community service. FTR opened in January 2015. Today, more than 350 people in recovery each week pass through our doors. They attend fitness classes, scale our climbing wall, learn how to paint and write poetry, lay down tracks in the audio studio, cook and eat healthy food together, empower women in early recovery, and reach out in service to others in need. Mostly though, they’re friends who hold each other up and hold each other accountable.</h2>	
				</div>
			</div>
