      ...
      <div>
        ...
        <Grid className="sponsors">
          ...
          <Grid.Column className="xsColumn hidden-sm hidden-md hidden-lg hidden-xl">
            <List>
              <List.Header className="donorColumnHeader">
                Our treatment partners mix and match the FTR pillars that work
                best for them. Some are exercise only; some combine exercise and
                nutrition; some choose exercise and art. One purchases
                memberships for their clients when they graduate. There are any
                number of ways treatment centers and sober living houses can
