	      ...
	      <Grid.Column className="tripGrid" mobile={16} tablet={4} computer={4}>
			...
			<Grid className="sponsors">
				<Grid.Column className="sponsorsColumn" mobile={16} tablet={5} computer={5}>
					...
					<List>
				      <List.Header className="donorColumnHeader">Special thanks to our generous Corporate and Foundation donors:</List.Header>
					    <List.Item as='a' className="singleDonor" >
					    	The Lawrence T. and Janet T. Dee Foundation</List.Item>
					    <List.Item as='a' className="singleDonor" >
					    	The George S. and Dolores D. Eccles Foundation</List.Item>
					    <List.Item as='a' className="singleDonor" >
					    	Church of Jesus Christ of Latter-Day Saints Foundation</List.Item>
					    <List.Item className="singleDonor" >
				    		Episcopal Diocese of Utah</List.Item>
					    <List.Item as='a' className="singleDonor" >
					    	Intermountain Healthcare</List.Item>
					    <List.Item as='a' className="singleDonor" >
					    	Larry H. Miller charities</List.Item>
					    <List.Item as='a' className="singleDonor" >
					    	Moulton Family Charitable Trust</List.Item>
					    <List.Item className="singleDonor" >
					    ...
					    <List.Item as='a' className="singleDonor" >
								Utah Medical Association</List.Item>
							<List.Item as='a' className="singleDonor" >
					    	Val and Edith Green Founation</List.Item>
					    <List.Item as='a' className="singleDonor" >
								The Wheeler Foundation</List.Item>
							<List.Item as='a' className="singleDonor" >
					    	Zions Bank</List.Item>
				  </List>
				</Grid.Column>

				<Grid.Column className="xsColumn hidden-sm hidden-md hidden-lg hidden-xl">	
					<List>
			      <List.Header className="donorColumnHeader">Our treatment partners mix and match the FTR pillars that work best for them. Some are exercise only; some combine exercise and nutrition; some choose exercise and art. One purchases memberships for their clients when they graduate. There are any number of ways treatment centers and sober living houses can involve their clients in our safe, active, healthy community. <br/>Contact <a href="mailto:Georgia@fit2recover.org">Georgia Gregersen</a> for our menu of services! </List.Header>
			      <List.Item as='a' className="singleDonor" href="https://www.acquarecovery.com/" target="_blank" rel="noopener noreferrer">
				    		Acqua Treatment</List.Item>
				    <List.Item as='a' className="singleDonor" href="http://www.ascendrecovery.com/" target="_blank" rel="noopener noreferrer">
				    	...
				    	<List.Item as='a' className="singleDonor" href="http://www.balancehouseut.com/" target="_blank" rel="noopener noreferrer">
				    		Balance House</List.Item>
				    	<List.Item as='a' className="singleDonor" href="https://brightonrecoverycenter.com/" target="_blank" rel="noopener noreferrer">
				    		Brighton Recovery Center</List.Item>
			    		<List.Item as='a' className="singleDonor" href="https://addictionfree.com/about-us/our-centers/outpatient-services-salt-lake" target="_blank" rel="noopener noreferrer">
				    		Cold Creek Behavioral Health</List.Item>
				    	<List.Item as='a' className="singleDonor" href="http://havenhelps.com/" target="_blank" rel="noopener noreferrer">
				    		The Haven</List.Item>
				    	<List.Item as='a' className="singleDonor" href="https://www.odysseyhouse.org/" target="_blank" rel="noopener noreferrer">
				    		Odyssey House of Utah</List.Item>
			    		<List.Item as='a' className="singleDonor" href="http://www.recoveryways.com/" target="_blank" rel="noopener noreferrer">
				    		Recovery Ways</List.Item>
					    ...
					    <List.Item as='a' className="singleDonor" href="http://www.saltlakebehavioralhealth.com/military-mental-health-program/strong-hope-womens-mental-health-program" target="_blank" rel="noopener noreferrer">
					    	Salt Lake Behavioral Health's Strong Hope</List.Item>
