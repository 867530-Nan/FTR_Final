      ...
      <div>
        ...
        <div className="newsletterHeader" style={styles.newsletterHeader}>
          <span
            ...
            style={styles.glyphiconEnvelope}
          />
          <h1
            className="newsletterHeaderWords"
            style={styles.newsletterHeaderWords}
          >
            &nbsp;Newsletter Archive&nbsp;
          </h1>
          <span
        ...
        <div className="aboutNewsletter" style={styles.aboutNewsletter}>
          <h2 className="aboutNewsletterWords">
            Keeping the Community Informed of FTR's 4 Pillars
          </h2>
        </div>
